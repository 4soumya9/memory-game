...
const MemoryGame = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-grey-100 p-4">
        ...
        {cards.map((card) => {
          return (
            <div
              ...
              className={`aspect-square flex items-center justify-center text-xl rounded-lg cursor-pointer transition-all duration-300  ${
                isFlipped(card.id)
                  ? isSolved(card.id)
      ...
      {/* Result  */}
      {won && (
        <div className="mt-4 px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors">
          You won{" "}
        </div>
      )}
